...
public class CriarNovoUsuarioCpfCommand : Notifiable<Notification>, ICommand
{
    public CriarNovoUsuarioCpfCommand(string primeiroNome, string sobrenome, string enderecoEmail, string numeroDocumento, string senha, string confirmacaoSenha)
    {
